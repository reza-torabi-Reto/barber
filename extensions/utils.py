...
#     date_to_str = "{} {} {}".format(time.year, time.month,time.day)
#     output = jalali.Gregorian(date_to_str).persian_tuple()
#     output = list(output)
#     for i,v in enumerate(jmonths):
#         if output[1] == i+1:
#             output[1] = v
#             break
#     # t = jalali.Gregorian(date_to_str).persian_tuple()
#     # output = "{} {} {}, ساعت {}:{}".format(
#     #     t[2],
#     #     t[1],
#     #     t[0]
