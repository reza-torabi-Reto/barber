...
urlpatterns = [
    ...
    path('shop/<int:shop_id>/barber-schedule/', views.manage_barber_schedule, name='manage_barber_schedule'),
    ...
    path('shop/<int:shop_id>/appointments_days/', views.manager_appointments_days, name='manager_appointments_days'),
